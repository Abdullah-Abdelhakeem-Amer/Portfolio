# Abdullah Abdelhakeem - Portfolio Website
...
Visit the live website: [https://abdullah6484.github.io/automotive-portfolio](https://abdullah6484.github.io/automotive-portfolio)
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/abdullah6484/automotive-portfolio.git
   cd automotive-portfolio/portfolio-website
   ```
...
2. **Enable GitHub Pages**
   ...
   - Choose branch: `main`
   - Folder: `/ (root)` or `/portfolio-website`
